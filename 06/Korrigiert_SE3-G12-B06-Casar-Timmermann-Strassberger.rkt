...
#|
  ...
  merge:
   ...
   finden
;;;;;
;Aber davon kann jeweils nur 1 Fall eintreten und nur ein rekursiver Aufruf kann auftreten
;somit auch linear rekursiv
;;;;;
  merge-sort:
   geschachtelt rekursiv (Aufruf von merge)
   baumrekursiv, Definition s.o.
;;;;;
;Zwar ist die rekursive Verwendung Argument von merge welches selbst eine rekursive Funktion ist,
;es handelt sich jedoch erst um geschachtelte Rekursion wenn in der rekursiven Verwendung der Funktion selbst die Funktion als Argument wieder rekursiv verwendet wird
;;;;;

|#

;;;;;
;Angabe ob direkte oder indirekte Rekursion fehlt jeweils
;
;6/10 Punkten
;;;;;
