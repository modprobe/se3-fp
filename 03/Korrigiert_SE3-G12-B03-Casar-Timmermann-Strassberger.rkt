...
(define translatormatrix (hash #\A "Alpha "
                               ...
                               #\Y "Yankee "
                               #\Z "Zulu "
                               #\space #\space));;;;;Komma, Punkt und Ziffern wurden vergessen
...
;;;;;
;Warum erfolgt die Darstellung mittels display?
;display wirkt über Seiteneffekte und entspricht somit nicht dem funktionalen Programmierstil
;Hier wäre die Zusammensetzung des Strings über string-append möglich
;der Ergebnisstring wäre dann der Rückgabewert der Funktion
;4/8 Punkten
;;;;;
...
(define flagdic (hash #\A A 
                   ...
                   #\Y Y
                   #\Z Z
                   #\space #\space));;;;;Die Ziffern wurden vergessen
...
;;;;;
;Siehe oben für Argumentation gegen Display
;Folgefehler
;8/8 Punkten
;
